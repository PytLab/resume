...
\textit{B.S.} in Computer Science and Technology (Second Major)
\datedsubsection{\textbf{East China University of Science and Technology (ECUST)}, Shanghai}{2010 -- 2014}
...
\begin{itemize}
  ...
  \item Developed the force field optimization program based on GAFT (Not open sourced, GitHub private repository)
\end{itemize}
\end{onehalfspacing}
